      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body row d-flex justify-content-space-between">
            <button  type="button" class="btn bg-gradient-secondary" v-on:click="getExportCsv"> CSV</button>
             <button  class="btn bg-gradient-primary" v-on:click="getExportXlsx">EXCEL</button>
